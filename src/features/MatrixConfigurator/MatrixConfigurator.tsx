...
import { MATRIX_LOWER_LIMIT, MATRIX_UPPER_LIMIT } from "../../shared/constants";
import { generateMatrix } from "../../shared/utils/generateMatrix.ts";
...
export const GenerateMatrix: FC = () => {
    ...
    return (
        <div>
            <h2 id="generate-matrix-title">Generate Matrix</h2>
            <form
            ...
            >
                <div className="generate-matrix-form__input-section">
                    ...
                    <input
                        ...
                        min={MATRIX_LOWER_LIMIT}
                        max={MATRIX_UPPER_LIMIT}
                    />
                </div>
                <div className="generate-matrix-form__input-section">
