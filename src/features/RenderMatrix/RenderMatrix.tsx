...
import { generateMatrixRow } from "../../shared/utils/generateMatrixRow.ts";
import { MATRIX_UPPER_LIMIT } from "../../shared/constants";
import { getColumnsHalfAmount } from "../../shared/utils/getColumnAverage.ts";
    ...
    return (
        <div>
            ...
            <button
                ...
                disabled={matrix.length >= MATRIX_UPPER_LIMIT}
            >
                Add new row
            </button>
